...
const MOCK_USERS = [
  ...
  { email: "hernando@test.com", password: "password", name: "Hernando Pachón", role: "user" as UserRole },
  { email: "maria@test.com", password: "password", name: "María López", role: "user" as UserRole },
];
